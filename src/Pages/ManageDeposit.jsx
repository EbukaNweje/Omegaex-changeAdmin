...
const ManageDeposit = () => {
    ...
    const acceptDeposit = (depositId) => {
        const url = `https://omega-exchange-back-end-one.vercel.app/api/confirm-deposit/${depositId}`;
        axios.post(url)
            .then((response) => {
    ...
    const getallDeposit = () => {
        const url = "https://omega-exchange-back-end-one.vercel.app/api/alldeposit";
        axios.get(url)
            .then((response) => {
